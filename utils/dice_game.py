...
class DiceGame:
    ...
    def register(self):
        ...
        while True:
            ...
            if self.user_manager.register_user(User(username, password)):
                break
    ...
    def login(self):
        ...
        if self.user_manager.login_user(User(username, password)):
    ...
    def play_game(self):
        ...
        for stages in range(1, 10 + 1):
            ...
            # if the user loses, the “Game over.You didn’t win any stages.”
